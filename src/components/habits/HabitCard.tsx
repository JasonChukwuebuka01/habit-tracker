...
export default function HabitCard({ habit, onEdit, onDelete, onUpdate }: HabitCardProps) {
    ...
    return (
        <div
            ...
            className={`group relative p-5 md:p-6 rounded-2xl border transition-all duration-500 ease-in-out ${isCompletedToday
        ...
        >
            <div className="flex justify-between items-start gap-3 md:gap-4">
                ...
                <button
                    ...
                    className={`flex-shrink-0 w-11 h-11 md:w-12 md:h-12 rounded-xl border-2 flex items-center justify-center transition-all active:scale-90 ${isCompletedToday
